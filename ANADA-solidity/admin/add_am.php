...
<?php  
        ...
        if( in_array($extension , $allowed_types)  ){
            ...
            if(move_uploaded_file($temp_loc, $location)){
                ...
                $sql = "INSERT INTO acte_m( num , nom , thumb ) VALUES( '$num' , '$nom' , '$new_file_name') ";
                ...
                if($result){
                    ...
                    $(document).ready( function(){
                        ...
                        $('#modalHead').hide();
                        $('#linkBtn').attr('href', 'con_am.php');
                        $('#linkBtn').text('Consulter un acte');
                        $('#addMsg').text('Acte de mariage ajouter avec succès!');
...
<script src="../js/block1.js"></script>
<div style=""> 
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">                       
                                    ...
                                    <h4 class="text-center">Archiver l'acte de mariage</h4><br>
                                ...
                                <div class="form-container"  style="margin-top:20%;">
                                    ...
                                    <form class="register" action="" method="post" enctype="multipart/form-data">
                                        <h3>Enrégistrer la trace numérique de l'acte de mariage</h3>
