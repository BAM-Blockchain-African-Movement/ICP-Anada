...
<?php  
        ...
        if( in_array($extension , $allowed_types)  ){
            ...
            if(move_uploaded_file($temp_loc, $location)){
                ...
                $sql = "INSERT INTO titre( num , nom , thumb ) VALUES( '$num' , '$nom' , '$new_file_name') ";
                ...
                if($result){
                    ...
                    $(document).ready( function(){
                        ...
                        $('#modalHead').hide();
                        $('#linkBtn').attr('href', 'con_t.php');
                        $('#linkBtn').text('Consulter un titre foncier');
                        $('#addMsg').text('Titre foncier ajouté avec succès!');
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">                       
                                    ...
                                    <h4 class="text-center">Archiver le titre foncier</h4><br>
                                ...
                                <div class="form-container"  style="margin-top:20%;">
                                    ...
                                    <form class="register" action="" method="post" enctype="multipart/form-data">
                                        <h3>Enrégistrer la trace numérique du titre foncier</h3>
