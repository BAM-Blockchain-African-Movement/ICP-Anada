...
<?php  
        ...
        if( in_array($extension , $allowed_types)  ){
            ...
            if(move_uploaded_file($temp_loc, $location)){
                ...
                $sql = "INSERT INTO acte_d( num , nom , thumb ) VALUES( '$num' , '$nom' , '$new_file_name') ";
                ...
                if($result){
                    ...
                    $(document).ready( function(){
                        ...
                        $('#addMsg').text('Acte de décès ajouter avec succès!');
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">                       
                                    ...
                                    <h4 class="text-center">Archiver l'acte de décès</h4><br>
                                ...
                                <div class="form-container"  style="margin-top:20%;">
                                    ...
                                    <form class="register" action="" method="post" enctype="multipart/form-data">
                                        <h3>Enrégistrer la trace numérique de l'acte de décès</h3>
                                            ...
                                            <div class="form-group">
                                                <input type="file" name="dp" accept="image/*" required  class="box">
                                            </div>
