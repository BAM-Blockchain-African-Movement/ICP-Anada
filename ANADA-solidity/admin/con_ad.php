                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">                       
                                    ...
                                    <h4 class="text-center">Réchercher l'acte de décès</h4><br>
                                ...
                                <?php 
                                    ...
                                    if( !empty($email) && !empty($pass) ){
                                        ...
                                        $sql_query = "SELECT * FROM acte_d WHERE num='$email' && nom = '$pass'  ";
                                ...
                                <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" style="margin-top:20%;">
                                    ...
                                    <!-- <?php echo $thumb; ?> -->
                                    <a href="upload/<?=  $thumb; ?>" style="font-size:20px; color:black;" download="">
                                        <img src="upload/<?=  $thumb; ?>" alt="" width="470">
                                    </a>                                    
                                </form>
