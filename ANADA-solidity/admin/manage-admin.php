...
<div class="container bg-white shadow">
    <div class="py-4 mt-5"> 
    <div class='text-center pb-2'><h4>Listes des centres d'états civils</h4></div>
    ...
    if( mysqli_num_rows($result) > 0){
        ...
        <td>   <?php if( $email !== $_SESSION["email"] ){
                $edit_icon = "<a href='edit-admin.php?id= {$id}' class='btn-sm btn-success float-right ml-3 '> <span ><i class='fa fa-edit '></i></span> </a>";
