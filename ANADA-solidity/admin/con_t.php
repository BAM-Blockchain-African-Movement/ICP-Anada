...
?>
    ...
    require_once "include/header.php";
?>
<script src="../js/block3.js"></script>
<div style=""> 
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">                       
                                    ...
                                    <h4 class="text-center">Réchercher le titre foncier</h4><br>
                                ...
                                <div class="form-container">
                                    ...
                                    <div class="form-group">
                                        <label >Nom(s) du propriétaire(s):</label>
                                ...
                                <?php 
                                    ...
                                    if( !empty($email) && !empty($pass) ){
                                        ...
                                        $sql_query = "SELECT * FROM titre WHERE num='$email' && nom = '$pass'  ";
                                ...
                                <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" style="margin-top:20%;">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="button" id="togg1" value="Afficher" class="btn btn-success btn-lg w-100 " style="background:RoyalBlue;" name="signin" >
                                            </div>
                                        </div>
                                    ...
                                    <center>
                                        <a href="upload/<?=  $thumb; ?>" id="d1" style="font-size:20px; color:black; display:none;" download="">
